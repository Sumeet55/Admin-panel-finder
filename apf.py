...
+------------------------------------|
''')
print(" \033[95m YOU MUST WRITE PROTOCOL HTTPS:// or HTTP:// ex: http://www.example.com , ex: https://www.example.com ")
print(" \033[95m YOU MUST WRITE / AT THE END OF THE EX: www.example.com/")
print("                                                                 ")
...
print ("--------------------------------------------------------------------------------------")
print ("\033[93m Thanx For Use My Script -SKBROOT-")
print ("--------------------------------------------------------------------------------------")	    	
